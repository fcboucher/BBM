...
TRAIT= Sim_BBM(tree,x0=0,Npts=100,sigma=1,bounds=c(-5, 5)) # TRAIT simulated on the tree, with many hits on the bounds: for that you need to source the function 'Sim_BBM.R'
